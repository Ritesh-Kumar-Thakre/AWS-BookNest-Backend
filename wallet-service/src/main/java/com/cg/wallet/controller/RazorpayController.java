...
@Tag(name = "Razorpay Integration", description = "Endpoints for creating Razorpay orders and verifying payment signatures")
public class RazorpayController {
	 ...
	 */
	@Operation(summary = "Create Razorpay Order", description = "Initializes a Razorpay payment order for a specific amount")
	 ...
	 */
	@Operation(summary = "Verify and Credit Wallet", description = "Verifies the Razorpay payment signature and credits the user's wallet")
	@PostMapping("/verify")
