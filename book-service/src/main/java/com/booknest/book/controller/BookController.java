...
@Tag(name = "Book Management", description = "Endpoints for adding, verifying, searching, and managing books and their images")
public class BookController {
	...
	@Operation(summary = "Add a new book", description = "Adds a new book to the catalog (requires verification)")
	@PostMapping("/addBook")
	...
	@Operation(summary = "Get pending books", description = "Admin only: Retrieves a list of books awaiting verification")
	@GetMapping("/pending")
	...
	@Operation(summary = "Verify a book", description = "Admin only: Marks a book as verified so it appears in the catalog")
	...
	@Operation(summary = "Get all verified books", description = "Retrieves a list of all verified books in the catalog")
	@GetMapping("/all")
	...
	@Operation(summary = "Get book by ID", description = "Retrieves details of a specific book by its ID")
	@GetMapping("/{bookId}")
	...
	@Operation(summary = "Search books", description = "Searches for books by category and value")
	@GetMapping("/search")
	...
	@Operation(summary = "Get featured books", description = "Retrieves a list of books marked as featured (e.g., top rated)")
	@GetMapping("/featured")
